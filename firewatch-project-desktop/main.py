...
class FireWatchApp(ctk.CTk):
    def __init__(self):
        ...
        self.SZ = 640  
        self.CONF_A = 0.20  # Alta sensibilidad para detectar llamas pequeñas
        self.CONF_B = 0.35
    ...
    def update_frame(self):
        ...
        if ret:
            ...
            if self.last_fire_dets and self.last_smoke_dets:
                ...
                # Si el estado vuelve a normal, permitimos que la siguiente amenaza envíe alerta inmediata
